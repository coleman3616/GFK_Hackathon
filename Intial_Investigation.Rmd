...
```
* Analyze top products in Cereal
Top parent brands: Big G, Kelloggs. Counted for a total of ~70% cereal in stores
Most favorite brand: Cheerios (>15%)
Both table Cereal and Data Maps do not have any null value, but NA appears when join two tables together. Around 1% either have false upc numbers or comes from other brands not included in the maps.
