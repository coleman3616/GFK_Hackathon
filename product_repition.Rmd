...
ggplot(aes(x = reorder(Brand,total_bought_brand), y = total_bought_brand, fill = Brand)) + 
  ...
  ggtitle("Year 2021")
```
* strangely Lysol had alot better sales in 2019, and 2020 but not 2021. 
...
desire for Lysol wipes because of covid.
...
#library(arules)
#rules <- apriori(All_Products, parameter = list(supp = 0.01, conf = 0.2))
